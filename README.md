...
gcloud scheduler jobs create http bgg-games-ranks-cacher --location=us-central1 --schedule="0 4 * * *" --uri="https://us-central1-zinovik-project.cloudfunctions.net/bgg-games-ranks-cacher" --oidc-service-account-email=zinovik-project@appspot.gserviceaccount.com --http-method=get
```
